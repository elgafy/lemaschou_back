...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Empty array to exclude all files
                ],
                 ...
                 */
                'exclude' => [
                    // Empty array as we're not backing up files
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'donotreply@lemaschou.sa'),
                'name' => env('MAIL_FROM_NAME', 'Le Maschou Riyadh'),
            ],
        ],
